...
namespace SocialballWebAPI.Migrations
{
    ...
    [Migration("20211104164137_TeamManagersAddedMigration")]
    partial class TeamManagersAddedMigration
    {
            ...
            modelBuilder.Entity("SocialballWebAPI.Models.TeamManager", b =>
                {
                    b.HasOne("SocialballWebAPI.Models.Team", "Team")
                        ...
                        .HasForeignKey("TeamId")
                        .HasConstraintName("FK_TeamManagers_Teams");

                    b.HasOne("SocialballWebAPI.Models.User", "User")
                        .WithOne("TeamManager")
                        .HasForeignKey("SocialballWebAPI.Models.TeamManager", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
